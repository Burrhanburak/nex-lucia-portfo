...
export const Footer = () => {
  return (
    <div className="">
      <div className="Footer_container__6pNfo">
        <Image
          alt=""
          loading="lazy"
          width={2000}
          height={800}
          data-nimg={1}
          className="Footer_bgImg__YdzGU"
          style={{ color: "transparent" }}
          src="/frm.png"
        />
        <div className="Footer_content__WG3KU">
          <div className="Footer_links__sNoYT">
            <div className="Footer_linkGroup__LhDJx">
              <div className="Footer_groupHead__eSnSI">Product</div>
              <div className="Footer_groupContent__rkIVW">
                <a className="Footer_footerLink__N575X" href="/store">
                  Store
                </a>
                <a className="Footer_footerLink__N575X" href="/pro">
                  Pro
                </a>
                <a className="Footer_footerLink__N575X" href="/teams">
                  Teams
                </a>
                <a className="Footer_footerLink__N575X" href="/pricing">
                  Pricing
                </a>
                <a className="Footer_footerLink__N575X" href="/changelog">
                  Changelog
                </a>
                <a className="Footer_footerLink__N575X" href="/browser-extension">
                  Browser Extension
                </a>
                <a className="Footer_footerLink__N575X" href="/developers">
                  Developers
                </a>
                <a className="Footer_footerLink__N575X" href="https://developers.raycast.com">
                  API Docs
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 16 16"
                    className="Footer_externalIcon___XRcS"
                  >
                    <path
                      stroke="currentColor"
                      strokeLinecap="round"
                ...
                <a className="Footer_footerLink__N575X" href="/manual">
                  Manual
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <a className="Footer_footerLink__N575X" href="/troubleshooting">
                  Troubleshooting
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <a className="Footer_footerLink__N575X" href="/faq">
                  FAQ
                </a>
              </div>
            </div>
            <div className="Footer_linkGroup__LhDJx">
              <div className="Footer_groupHead__eSnSI">Company</div>
              <div className="Footer_groupContent__rkIVW">
                <a className="Footer_footerLink__N575X" href="/careers">
                  Careers
                </a>
                <a className="Footer_footerLink__N575X" href="/why">
                  Manifesto
                </a>
                <a className="Footer_footerLink__N575X" href="/privacy">
                  Privacy Policy
                </a>
                <a className="Footer_footerLink__N575X" href="/terms-of-service">
                  Terms of Service
                </a>
                <a className="Footer_footerLink__N575X" href="/dpa">
                  DPA
                </a>
                <a className="Footer_footerLink__N575X" href="/press">
                  Press Kit
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <a className="Footer_footerLink__N575X" href="mailto:hello@raycast.com">
                  Contact
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            <div className="Footer_linkGroup__LhDJx">
              <div className="Footer_groupHead__eSnSI">Community</div>
              <div className="Footer_groupContent__rkIVW">
                <a className="Footer_footerLink__N575X" href="/community-stories">
                  Community Stories
                </a>
                <a className="Footer_footerLink__N575X" href="/community">
                  Slack
                </a>
                <a className="Footer_footerLink__N575X" href="https://twitter.com/raycastapp">
                  X/Twitter
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <a className="Footer_footerLink__N575X" href="https://github.com/raycast">
                  GitHub
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <a className="Footer_footerLink__N575X" href="https://www.dribbble.com/raycastapp">
                  Dribbble
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
            ...
            <div className="Footer_linkGroup__LhDJx">
              <div className="Footer_groupHead__eSnSI">By Raycast</div>
              <div className="Footer_groupContent__rkIVW">
                <a className="Footer_footerLink__N575X" href="https://snippets.ray.so">
                  Snippets
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <a className="Footer_footerLink__N575X" href="https://prompts.ray.so">
                  Prompts
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <a className="Footer_footerLink__N575X" href="https://presets.ray.so">
                  Chat Presets
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <a className="Footer_footerLink__N575X" href="https://www.ray.so">
                  ray.so
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <a className="Footer_footerLink__N575X" href="https://icon.ray.so">
                  Icon Maker
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <a className="Footer_footerLink__N575X" href="https://merch.raycast.com">
                  Merch
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                ...
                <a className="Footer_footerLink__N575X" href="/wallpapers">
                  Wallpapers
                </a>
              </div>
            </div>
          </div>
          <div className="Footer_newsletter__wZsad">
            <div className="Footer_text__UYcCR">
              <h5>Subscribe to our newsletter.</h5>
              <p>Get product updates and news in your inbox. No spam.</p>
            </div>
            <div className="Footer_formContainer__iSuGc">
              <form className="SubscribeForm_newsletterForm__btavW">
                <div>
                  <div className="Input_outerWrapper__0nCNU Input_absoluteError__bRjDz">
                    <input
                      placeholder="chris@swift-lang.com"
                      className="Input_input__trG8n"
                      defaultValue=""
                    />
                  </div>
                </div>
                <div className="Submit_inputWrapper__z2DLF Submit_submitWrapper__CDoSb">
                  <input type="submit" className="Submit_submit__Qst6_" defaultValue="Subscribe" />
                  <span className="Submit_glow__0gmKP" />
                </div>
                <span>
                  By submitting your email address, you agree to receive Raycast’s monthly
                  newsletter. For more information, please read our{" "}
                  <a href="/privacy">privacy policy</a>. You can always withdraw your consent.
                </span>
              </form>
            </div>
          </div>
          <svg
            ...
            className="Footer_raycastTextBig__K_ZT9"
          >
            <mask id="raycast-big_svg__c" fill="#fff">
              <path
                fillRule="evenodd"
            ...
            <g filter="url(#raycast-big_svg__a)">
              <path
                fill="#08090B"
                fillOpacity="0.1"
                fillRule="evenodd"
                ...
                style={
                  {
                    fill: "color(display-p3 .0314 .0353 .0431)",
                    "fill-opacity": "0.1",
            ...
            <defs>
              ...
              >
                <stop
                  stopColor="#fff"
                  style={{ "stop-color": "white", "stop-opacity": "1" } as React.CSSProperties}
                />
                ...
                <stop
                  ...
                  stopColor="#fff"
                  stopOpacity="0.1"
                  style={{ "stop-color": "white", "stop-opacity": "0.1" } as React.CSSProperties}
                />
                <stop
                  offset="0.99"
                  stopColor="#fff"
              ...
              >
                ...
                <feBlend in2="shape" result="effect1_innerShadow_2774_29167" />
              </filter>
            </defs>
          </svg>
        </div>
